...
Product Name, Product Version   Rdbms:07.03.03
Rdbms:09.02.00.02 
...
Access Privileges:
     SELECT on V_$LOCK, V_$SESSION, SYS.USER$, SYS.OBJ$ 
...
Description 
The following locking information script provides fully DECODED 
information regarding the locks currently held in the database. 
The report generated is fairly complex and difficult to read, 
but has considerable detail. 
...
NOTE:  The following report is fairly complex and difficult to format here,  
as it is over eighty columns wide. 
...
------------------------- -------------------- --------------------  
------------------ ----------------------------------------                    
SCOTT         7 ttyp9  None                            UPDATE                    
 Exclusive            NONE                 196615-215922      TX - Transaction  
enqueue lock                               
                       SCOTT.TABLE_CONFIG              UPDATE                    
 Row Exclusive        NONE                 3364-0             TM - DML enqueue  
lock                                       
 
SCOTT         8 ttyr5  None                            INSERT                    
 Exclusive            NONE                 196632-215907      TX - Transaction  
enqueue lock      
                       SCOTT.TT                        INSERT      
 Row Exclusive        NONE                 3384-0             TM - DML enqueue  
lock                                       
 
SYS           6 ttyq3  None                            UPDATE                    
 NONE                 Exclusive            196615-215922      TX - Transaction  
enqueue lock             
                       None                            UPDATE             
 Exclusive            NONE                 131093-2324        TX - Transaction  
enqueue lock                               
                       SCOTT.TABLE_CONFIG              UPDATE                    
 Row Exclusive        NONE                 3364-0             TM - DML enqueue  
lock                   
 
SYSTEM       11 ttyq4  None                            UPDATE                    
 NONE                 Exclusive            196615-215922      TX - Transaction  
enqueue lock                               
                       SCOTT.TABLE_CONFIG              UPDATE                    
 Row Exclusive     NONE                 3364-0                TM - DML enqueue  
...
SYSTEM       12 ttyr6  None DELETE                    
 Exclusive            NONE                 131100-2321        TX - Transaction  
enqueue lock                               
             SCOTT.TT                                  DELETE                    
 Row Exclusive        NONE                 3384-0             TM - DML enqueue  
lock                                 
 
USUPPORT      9 ttyp1  None                            SELECT                    
 Exclusive            NONE                 131083-2316        TX - Transaction  
enqueue lock
